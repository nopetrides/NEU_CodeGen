...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class TextAnimatorSubtitlePanel : StandardUISubtitlePanel
    {
        ...
        {
            base.Start();
            var textAnimatorPlayer = subtitleText.gameObject.GetComponent<Febucci.UI.TypewriterByWord>();
        ...
        {
            var textAnimator = subtitleText.gameObject.GetComponent<Febucci.UI.TextAnimator_TMP>();
