...
2025-01-10:
- Fixed: MusicManager could play title music in other scenes if scene had 
  another MenuSystem instance.

2024-11-13:
- Fixed: Languages dropdown (if set active in Options menu) now shows languages 
  defined in Dialogue Manager's Text Table.

2024-10-04:
- Fixed: ScrollToMe now correctly handles inactive children.

2024-04-12:
- SelectNextIfNotInteractable now uses InputDeviceManager for input system independence.

2023-06-19:
- Added SaveHelper.returningToTitleMenu event.
- Added support for Scene Streamer.

2022-12-26:
- Fixed bug that didn't unregister event hook after returning to title menu.

2022-10-18:
- Returning to title menu now resets game state and stops any active conversations.

2022-09-07:
- Fixed Options script to allow some UI elements to be left unassigned.
